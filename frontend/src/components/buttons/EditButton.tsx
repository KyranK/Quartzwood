    ...
    return (
        <>
            {!editmode ?
                ...
                :
                <button className="rounded bg-gray-600 px-4 py-2 text-white shadow-sm shadow-red-200 transition hover:bg-blue-700" onClick={() => set_editmode(false)}>{"Done"}</button>
            }
        </>
    )
}